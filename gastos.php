      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex flex-row g-3 align-items-center ">
            <div class="mb-3 col-md-2">
                <label for="srcDato" class="col-form-label h1">Buscar gasto entrada:</label>
            </div>
            <div class="input-group mb-3 ">
                <input type="text" id="srcDato" onkeyup="buscarTeclado()" class="form-control">
  ...
  ?>
    ...
    <script type="text/javascript">
        ...
        async function initPaginador(){
          const response = await fetch('http://localhost/sieslite/api/gastos.php?opc=6', {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json'
              },
        ...
        async function cargarDatos(){
          const response = await fetch('http://localhost/sieslite/api/gastos.php?opc=1', {
              ...
              body: JSON.stringify({"idGastoEntrada" : null,"buscar" :datoSrc , "pagina" : pagina, "limite" : limite })
          });
          const json = await response.json();
          datos = json.data ; 
        }
      ...
      async function remover(indice){
        ...
        if(respuestaDialog.isConfirmed){
          ...
          "montoTotal" : datoBorrar.montoTotal
          }
