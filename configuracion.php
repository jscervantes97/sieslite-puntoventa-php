...
<html lang="en">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex flex-row g-3 align-items-center border-bottom">
            ...
            <div class="input-group mb-3 ">
                <input type="text" id="srcUsuario" onkeyup="buscarTeclado()" class="form-control" autocomplete="off">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="d-flex flex-column">
                ...
                <div style="display : flex; flex-direction : flex-row; flex-wrap: wrap; justify-content : flex-start; " id="chckboxes">
  ...
  ?>
    ...
    <script type="text/javascript">
        ...
        async function cargarOpcionesModulos(){
          const response = await fetch('http://localhost/sieslite/api/usuario.php?opc=6', {
              method: 'POST',
              headers: {
          ...
          modulos = json.data ; 
          console.log(modulos);
          await renderOpcionesModulos();
        }

        async function renderOpcionesModulos(){
          let salida =``;
          modulos.map((modulo, index) => {
            salida += `<div class="form-check" style="margin-left:5px;">
                        <input class="form-check-input" type="checkbox" value="" id="chckbx${modulo.idModulo}">
                        <label class="form-check-label" for="flexCheckDefault">
                          ${modulo.nombre}
                        </label>
                      </div>`;
          });
          document.getElementById("chckboxes").innerHTML =salida ;
        }
        ...
        async function editarCrearUsuario(indice){
          ...
          if(indice == null){
            ...
            //chckbx$
            if(usuarioSeleccionado.modulos != "0"){
              let modulosArray = usuarioSeleccionado.modulos.split(",");
              //console.log(modulosArray);
              modulosArray.map(modulo => document.getElementById("chckbx"+modulo).checked = true );
            }
          }
        ...
        async function guardarDatos(){
          ...
          let modulosSelected = modulos.filter((modulo , indx)=> document.getElementById("chckbx"+modulo.idModulo).checked == true ).map(u => u.idModulo).join(',')
          ...
          let usuarioJson = {
            ...
            "status": 1,
            "modulos" : modulosSelected == "" ? "0" : modulosSelected
          }
