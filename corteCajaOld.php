      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div id="bodyCorte">
          <div class="d-flex flex-column h3 border" >
              ...
              <div class="p-2 d-flex flex-row border-bottom">
                  <span class="p-2">Ganancia Neta: </span><span id="spanTotalGanancia"  class="p-2"> 2000$</span>
              </div>
              <div class="p-2 d-flex flex-row border-bottom">
                  <span class="p-2">Total Abonos : </span><span id="spanAbonos"  class="p-2"> 200</span>
              </div>
              <div class="p-2 d-flex flex-row border-bottom">
  ...
  ?>
    ...
    <script type="text/javascript">
      ...
      async function initComponents(){
        ...
        document.getElementById("spanAbonos").textContent = "$" + json1.data.totalAbonado ;
