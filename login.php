...
if(isset($_POST['cajaUsuario']) && isset($_POST['cajaContra'])){
    ...
    if($resultado->getData() != null){
        ...
        $_SESSION['modulos'] = $resultado->getData()->getModulos();
        $_SESSION['arrModulos'] = $resultado->getData()->getModulosArray();
    }
    else {
        $msgInicioSesion = $resultado->getMsg();
    }
    ...
    <body>
        <div class="container-fluid">
            <div style="display: flex; align-items: center; justify-content: center; padding-top : 5%;">
                <img src="pdf/images/logo2.png" style="width:200px;height:200px;">
            </div>
            
            <div class="row justify-content-center text-center align-items-center" >
                
                <form method="post" action = "login.php" style="width:50%" autocomplete="off">
                <!-- Email input -->
                <h2>Bienvenido</h2>
